...
import { Home, BarChart3, BookOpen, Settings, Mic, FileQuestion, UserSquare2 } from 'lucide-react';
...
function App() {
  return (
    <Router>
      <div className="min-h-screen bg-gradient-to-br from-blue-500 via-pink-500 to-yellow-400">
        <Navbar />
